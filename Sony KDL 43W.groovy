 ...
 */
metadata {
	definition (name: "Sony KDL 43W", namespace: "AdamV", author: "AdamV") {
		capability "Actuator"
		capability "Button"
...
/*    preferences {
	...
	tiles {
        ...
        standardTile("push10", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "DJ / Bluetooth", icon: "http://94.23.40.33/smartthings/assets/rocki.png", action: "push17"
		} 
		main (["button","push1","push2", "push3", "push4"])
		details(["push1","push2","button","push3","push4","dummy1","hold1","hold2","dummy2","hold3","hold4","push5", "push6","push7","push8","push9", "push10"])
	}
}
