 ...
 */
metadata {
	definition (name: "Denon AVR X2000", namespace: "AdamV", author: "AdamV") {
		capability "Actuator"
		capability "Button"
...
/*    preferences {
	...
	tiles {
		standardTile("button", "device.button", canChangeBackground: true, width: 0, height: 0, decoration: "flat") {
			state "default", label: "CONTROL", icon: "st.Electronics.electronics19", backgroundColor: "#ffffff"
		}
 		standardTile("push1", "device.button", width: 1, height: 1 ,decoration: "flat", canChangeBackground: true) {
			state "default", label: "Power On/Off", icon: "http://94.23.40.33/smartthings/assets/power.png",  action: "push1"
		} 
 		...
 		standardTile("push3", "device.button", canChangeBackground: true, width: 1, height: 1, decoration: "flat") {
			state "default", label: "Mute", icon: "http://94.23.40.33/smartthings/assets/mute.png", action: "push7"
		} 
 		...
 		standardTile("hold2", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Option", icon: "http://94.23.40.33/smartthings/assets/menu.png", action: "push8"
		}          
        ...
        standardTile("push5", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "setup", icon: "http://94.23.40.33/smartthings/assets/setup.png", action: "push12"
		} 
        ...
        standardTile("push7", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Apple TV", icon: "http://94.23.40.33/smartthings/assets/apple.png", action: "push14"
		} 
        standardTile("push8", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Nexus/Chromecast", icon: "http://94.23.40.33/smartthings/assets/android.png", action: "push15"
		} 
        standardTile("push9", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Blu-ray / DVD", icon: "http://94.23.40.33/smartthings/assets/blu.png", action: "push16"
		} 
        standardTile("push10", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "DJ / Bluetooth", icon: "http://94.23.40.33/smartthings/assets/volup.png", action: "push18"
		} 
        standardTile("push11", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "DLNA", icon: "http://94.23.40.33/smartthings/assets/rocki.png", action: "push17"
		} 
        
		main (["button","push1","push2", "push3", "push4"])
		details(["push1","push2","button","push3","push4","dummy1","hold1","hold2","dummy2","hold3","hold4","push5", "push6","push7","push8","push9", "push10", "push11"])
	}
}
